...
export class CrossDepartmentTopPerformersSummaryDto {
  @ApiProperty({ description: 'Total number of departments analyzed', example: 5 })
  ...
  @ApiProperty({ description: 'Average performance percentage across all top performers', example: 110.5 })
...
export class CrossDepartmentTopPerformersResponseDto {
  ...
  @ApiProperty({ description: 'Summary statistics', type: CrossDepartmentTopPerformersSummaryDto })
  summary: CrossDepartmentTopPerformersSummaryDto;

  @ApiProperty({ description: 'Top performers from each department', type: [CrossDepartmentTopPerformerDto] })
  data: CrossDepartmentTopPerformerDto[];

  @ApiProperty({ description: 'Response metadata', type: CrossDepartmentTopPerformersMetadataDto })
