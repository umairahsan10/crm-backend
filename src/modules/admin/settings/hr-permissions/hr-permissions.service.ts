...
export class HrPermissionsService {
   ...
   */
  async getAllHrPermissions(page: number = 1, limit: number = 10, employeeId?: number): Promise<HrPermissionsListResponseDto> {
   ...
   */
  async createHrPermission(dto: CreateHrPermissionDto): Promise<HrPermissionResponseDto> {
   ...
   * Update HR record
   */
  async updateHrPermission(id: number, dto: UpdateHrPermissionDto): Promise<HrPermissionResponseDto> {
    ...
    try {
      ...
      if (dto.attendancePermission !== undefined) updateData.attendancePermission = dto.attendancePermission;
      if (dto.salaryPermission !== undefined) updateData.salaryPermission = dto.salaryPermission;
      if (dto.commissionPermission !== undefined) updateData.commissionPermission = dto.commissionPermission;
      if (dto.employeeAddPermission !== undefined) updateData.employeeAddPermission = dto.employeeAddPermission;
      if (dto.terminationsHandle !== undefined) updateData.terminationsHandle = dto.terminationsHandle;
      if (dto.monthlyRequestApprovals !== undefined) updateData.monthlyRequestApprovals = dto.monthlyRequestApprovals;
      ...
      if (dto.shiftTimingSet !== undefined) updateData.shiftTimingSet = dto.shiftTimingSet;
