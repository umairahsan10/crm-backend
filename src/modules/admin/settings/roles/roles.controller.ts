...
export class RolesController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve all roles with pagination and search. Admin only.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOkResponse({
    type: AdminRolesListResponseDto,
  ...
  @ApiOperation({
    summary: 'Delete role',
    description:
      'Delete a role by ID. Cannot delete if role has employees. Admin only.',
  })
  @ApiParam({ name: 'id', type: Number, example: 1, description: 'Role ID' })
  @ApiOkResponse({
  ...
  @ApiBadRequestResponse({
    description: 'Bad Request: Role has employees or deletion failed.',
  })
  @ApiNotFoundResponse({ description: 'Role not found.' })
  @ApiUnauthorizedResponse({
    description: 'Unauthorized: Invalid or missing token.',
