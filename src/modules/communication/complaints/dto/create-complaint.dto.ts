...
export class CreateComplaintDto {
  @ApiProperty({
    example: 12,
    description: 'ID of the employee who raised the complaint',
  })
  ...
  @ApiPropertyOptional({
    example: 45,
    description: 'ID of the employee against whom the complaint is made',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 3,
    description: 'Department ID related to the complaint',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Harassment',
    description: 'Type of complaint (e.g., Harassment, Misconduct, etc.)',
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: 'Workplace misconduct',
    description: 'Short subject of the complaint',
  })
  ...
  @ApiPropertyOptional({
    example: 8,
    description: 'Employee ID to whom the complaint is assigned for resolution',
  })
  @IsOptional()
