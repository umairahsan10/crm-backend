...
export class UpdateTeamDto {
  @ApiPropertyOptional({ description: 'Updated name of the team', example: 'Advanced Development Team' })
  @IsOptional()
  @IsString()
  name?: string;

  @ApiPropertyOptional({ description: 'Employee ID of the team lead (can be null to remove lead)', example: 5 })
  @IsOptional()
