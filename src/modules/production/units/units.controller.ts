...
export class UnitsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of units based on user role and permissions',
  })
  ...
  @Departments('Production')
  @ApiOperation({
    summary: 'Get available teams to assign to production units',
  })
  @ApiQuery({
    name: 'assigned',
    required: false,
    description: 'Filter by already assigned teams (true/false)',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Unit details with teams and projects',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Team removed from unit successfully',
  })
