...
export class UpdateClientDto {
  ...
  @ApiPropertyOptional({
    example: 'newP@ssw0rd!',
    description:
      'Updated hashed password (optional, if password needs to be changed)',
  })
  @IsOptional()
  @IsString()
  @MinLength(6)
  ...
  @ApiPropertyOptional({
    example: '456 Market St, Suite 200',
  ...
  @ApiPropertyOptional({
    example: 7,
    description: 'Industry ID associated with the client',
  })
  @IsOptional()
  @IsInt()
  industryId?: number;
  ...
  @ApiPropertyOptional({
    example: 'Client requested billing contact update',
