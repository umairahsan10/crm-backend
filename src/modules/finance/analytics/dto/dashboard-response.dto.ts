...
export class PeriodComparisonDto {
  ...
  @ApiProperty({
    description: 'Difference amount (current - previous)',
    example: 15000,
  })
  difference: number;
...
export class TimeSeriesDataPointDto {
  @ApiProperty({
    description: 'Date label (YYYY-MM-DD for daily, YYYY-MM for monthly, etc.)',
    example: '2024-10-15',
  })
  date: string;
  ...
  @ApiProperty({
    description: 'Liability amount for this period',
    example: 2000,
  })
  liability: number;
  ...
  @ApiProperty({
    description: 'Net profit amount (revenue - expense)',
    example: 2000,
  })
  netProfit: number;
...
export class RevenueMetricsDto {
  ...
  @ApiProperty({
    description: 'This quarter metrics',
    type: TimePeriodMetricsDto,
  })
  ...
  @ApiProperty({
    description: 'Top categories breakdown',
    type: [CategoryBreakdownDto],
  })
  topCategories: CategoryBreakdownDto[];

  @ApiProperty({
    description: 'Top sources breakdown',
    type: [CategoryBreakdownDto],
  })
...
export class ExpenseMetricsDto {
  ...
  @ApiProperty({
    description: 'Top payment methods breakdown',
    type: [CategoryBreakdownDto],
  })
...
export class FinancialSummaryDto {
  ...
  @ApiProperty({
    description: 'Net position (assets - liabilities)',
    example: 150000,
  })
  netPosition: number;
  ...
  @ApiProperty({
    description: 'Available cash (revenue - expenses - unpaid liabilities)',
    example: 730000,
  })
  availableCash: number;

  @ApiProperty({
    description: 'Monthly net profit (revenue - expenses for this month)',
    example: 75000,
  })
...
export class TrendDataDto {
  @ApiProperty({
    description: 'Daily trend data (last 30 days)',
    type: [TimeSeriesDataPointDto],
  })
  daily: TimeSeriesDataPointDto[];

  @ApiProperty({
    description: 'Weekly trend data (last 12 weeks)',
    type: [TimeSeriesDataPointDto],
  })
  ...
  @ApiProperty({
    description:
      'Monthly trend data (January to current month of current year)',
    type: [TimeSeriesDataPointDto],
  })
...
export class DashboardWidgetsDto {
  @ApiProperty({
    description: 'Key financial metrics widgets',
    type: [WidgetMetricDto],
  })
  keyMetrics: WidgetMetricDto[];

  @ApiProperty({
    description: 'Revenue breakdown widget data',
    type: [CategoryBreakdownDto],
  })
  revenueBreakdown: CategoryBreakdownDto[];

  @ApiProperty({
    description: 'Expense breakdown widget data',
    type: [CategoryBreakdownDto],
  })
...
export class DashboardDataDto {
  ...
  @ApiProperty({
    description: 'Revenue metrics by time period',
    type: RevenueMetricsDto,
  })
  revenues: RevenueMetricsDto;

  @ApiProperty({
    description: 'Expense metrics by time period',
    type: ExpenseMetricsDto,
  })
  expenses: ExpenseMetricsDto;

  @ApiProperty({
    description: 'Liability metrics by time period',
    type: LiabilityMetricsDto,
  })
  ...
  @ApiProperty({
    description: 'Widget data for dashboard components',
  ...
  @ApiProperty({
    ...
    example: { currentPeriod: '2024-10', previousPeriod: '2024-09' },
  })
  periodInfo: {
