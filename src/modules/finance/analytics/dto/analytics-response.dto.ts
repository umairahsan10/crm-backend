...
export class SummaryStatsDto {
  ...
  @ApiProperty({ description: 'Total current value of all assets', example: 200000 })
  ...
  @ApiProperty({ description: 'Net financial position (income - expenses - unpaid liabilities)', example: 55000 })
  netPosition: number;
}
...
export class AssetStatsDto {
  ...
  @ApiProperty({ description: 'Total purchase value of all assets', example: 180000 })
  ...
  @ApiProperty({ description: 'Average depreciation rate percentage', example: 11.11 })
...
export class LiabilityStatsDto {
  ...
  @ApiProperty({ description: 'Total amount of all liabilities', example: 50000 })
  totalAmount: number;
...
export class FinanceAnalyticsResponseDto {
  ...
  @ApiProperty({ description: 'Response message', example: 'Finance analytics retrieved successfully' })
  message: string;
