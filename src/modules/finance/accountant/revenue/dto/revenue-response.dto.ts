...
export class TransactionResponseDto {
  ...
  @ApiPropertyOptional({
    example: 'Payment received for October',
  ...
  @ApiPropertyOptional({
    ...
    description: 'Client details if applicable',
  })
...
export class RevenueResponseDto {
  ...
  @ApiPropertyOptional({
    example: '2025-10-14T10:30:00Z',
    description: 'Date revenue was received',
  })
  receivedOn: string | null;

  @ApiProperty({
    example: 'CASH',
    description: 'Payment method used for the revenue',
  })
  paymentMethod: string;
  ...
  @ApiPropertyOptional({
    example: 12,
    description: 'Employee who created the revenue',
  })
  createdBy: number | null;

  @ApiPropertyOptional({
    example: 101,
    description: 'Linked transaction ID, if any',
  })
  transactionId: number | null;

  @ApiProperty({
    example: '2025-10-14T10:30:00Z',
    description: 'Revenue creation timestamp',
  })
  createdAt: string;

  @ApiProperty({
    example: '2025-10-14T10:35:00Z',
    description: 'Revenue last update timestamp',
  })
  updatedAt: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Linked lead details',
  })
  lead: LeadResponseDto | null;

  @ApiPropertyOptional({
    type: () => InvoiceResponseDto,
    description: 'Linked invoice details',
  })
...
export class RevenueListResponseDto {
  ...
  @ApiProperty({
    example: 'Revenues retrieved successfully',
...
export class RevenueSingleResponseDto {
  ...
  @ApiProperty({
    ...
    description: 'Single revenue details',
  })
  data: RevenueResponseDto;
}
