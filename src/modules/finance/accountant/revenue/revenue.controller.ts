...
export class RevenueController {
  ...
  @ApiResponse({
    ...
    type: RevenueCreateResponseDto,
  })
  @ApiResponse({
    status: 400,
    description: 'Invalid input or lead/invoice mismatch',
  })
  async createRevenue(
  ...
  @ApiQuery({
    name: 'fromDate',
    required: false,
    description: 'Filter revenues from date (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'toDate',
    required: false,
    description: 'Filter revenues to date (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    name: 'search',
    required: false,
    description: 'Search term to filter revenues by source or category',
  })
  @ApiResponse({
    status: 200,
    description: 'List of revenues',
    type: RevenueListResponseDto,
  })
