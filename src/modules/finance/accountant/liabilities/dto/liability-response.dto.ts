...
export class ExpenseResponseDto {
  ...
  @ApiPropertyOptional({
    example: 'Purchased pens and papers',
...
export class LiabilityResponseDto {
  ...
  @ApiProperty({
    example: '2025-10-31',
    description: 'Due date of the liability',
  })
  dueDate: Date;

  @ApiProperty({
    example: false,
    description: 'Whether the liability is paid or not',
  })
  isPaid: boolean;

  @ApiProperty({
    example: 'Unpaid',
    description: 'Status of the liability (Paid or Unpaid)',
  })
  status: string;

  @ApiPropertyOptional({
    example: '2025-10-14',
    description: 'Date when the liability was paid',
  })
  paidOn?: Date;
  ...
  @ApiProperty({
    example: 12,
    description: 'ID of the employee who created the liability',
  })
  createdBy: number;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Vendor details associated with the liability',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'Linked expense details, if any',
  })
...
export class LiabilityListResponseDto {
  ...
  @ApiProperty({
    example: 'Liabilities retrieved successfully',
...
export class LiabilityDetailResponseDto {
  ...
  @ApiProperty({
    example: 'Liability retrieved successfully',
    description: 'Response message',
  })
  message: string;
  ...
  @ApiProperty({
    type: LiabilityResponseDto,
    description: 'Single liability details',
  })
  data: LiabilityResponseDto;
}
...
export class LiabilityCreateResponseDto {
  ...
  @ApiProperty({
    example: 'Liability created successfully',
    description: 'Response message',
  })
  message: string;
...
export class LiabilityUpdateResponseDto {
  ...
  @ApiProperty({
    example: 'Liability updated successfully',
    description: 'Response message',
  })
  message: string;
...
export class LiabilityMarkPaidResponseDto {
  ...
  @ApiProperty({
    example: 'Liability marked as paid successfully',
    description: 'Response message',
  })
  message: string;
