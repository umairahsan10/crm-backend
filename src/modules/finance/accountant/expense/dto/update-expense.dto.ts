...
export class UpdateExpenseDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Updated date when the expense was paid',
  })
  @IsOptional()
  @IsDateString()
  paidOn?: string;
  ...
  @ApiPropertyOptional({
    example: 'Bought pens and papers',
  ...
  @ApiPropertyOptional({
    example: 'ACCOUNTANT',
    description: 'Updated role that processed the expense',
  ...
  @ApiPropertyOptional({
    example: 5,
    description: 'Updated vendor ID, if applicable',
  })
  @IsOptional()
  @IsNumber()
  @IsPositive()
