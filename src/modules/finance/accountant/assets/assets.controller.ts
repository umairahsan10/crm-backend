...
export class AssetsController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new asset with a linked transaction record.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all assets with optional filtering by category, date, employee, or value ranges.',
  })
  @ApiQuery({
    name: 'category',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Filter from purchase date (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'toDate',
    required: false,
    type: String,
    description: 'Filter to purchase date (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'createdBy',
    required: false,
    type: String,
    description: 'Filter by employee ID who created the asset',
  })
  @ApiQuery({
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search term to filter assets by title or category',
  })
  @ApiResponse({
    status: 200,
  ...
  async getAllAssets(
    ...
    const filters = {
      ...
      minPurchaseValue: query.minPurchaseValue
        ? parseFloat(query.minPurchaseValue)
        : undefined,
      maxPurchaseValue: query.maxPurchaseValue
        ? parseFloat(query.maxPurchaseValue)
        : undefined,
      minCurrentValue: query.minCurrentValue
        ? parseFloat(query.minCurrentValue)
        : undefined,
      maxCurrentValue: query.maxCurrentValue
        ? parseFloat(query.maxCurrentValue)
        : undefined,
    };
  ...
  @Permissions(PermissionName.assets_permission)
  @ApiOperation({
    summary: 'Get asset statistics overview',
    description:
      'Retrieve comprehensive asset statistics including depreciation and category breakdown.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed information about a specific asset including transaction and vendor.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Asset ID' })
  @ApiResponse({
    status: 200,
    description: 'Asset retrieved successfully',
    type: AssetSingleResponseDto,
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiOperation({
    ...
    description:
      'Update asset details and linked transaction if purchase value changes.',
  })
  @ApiResponse({
    status: 200,
    description: 'Asset updated successfully',
    type: AssetUpdateResponseDto,
  })
  @ApiResponse({
    status: 400,
