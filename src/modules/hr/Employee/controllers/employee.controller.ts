...
export class EmployeeController {
  ...
  @Departments('HR')
  @Permissions(
    PermissionName.terminations_handle,
    PermissionName.salary_permission,
  )
  ...
  @ApiOperation({
    summary:
      'Create a complete employee record including department-specific data and bank account',
  })
  @ApiBody({ type: CreateCompleteEmployeeDto })
  @ApiResponse({
    status: 201,
    description: 'Complete employee created successfully',
  })
  ...
  @ApiOperation({
    summary: 'Get all employees with optional filters and pagination',
  })
  ...
  async getEmployees(
    ...
    @Request() req: AuthenticatedRequest,
  ): Promise<EmployeesListResponseDto> {
  ...
  @ApiResponse({
    ...
    type: EmployeeStatisticsResponseDto,
  })
  async getEmployeeStatistics(
    @Request() req: AuthenticatedRequest,
  ): Promise<EmployeeStatisticsResponseDto> {
  ...
  async getDepartmentForEmployee(
    @Param('id', ParseIntPipe) id: number,
    @Request() req: AuthenticatedRequest,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'HR logs retrieved',
    type: HrLogsListResponseDto,
  })
  async getHrLogs(
    @Query() query: GetHrLogsDto,
    @Request() req: AuthenticatedRequest,
  ): Promise<HrLogsListResponseDto> {
  ...
  @ApiResponse({
    status: 200,
    description: 'HR logs stats retrieved',
    type: HrLogsStatsResponseDto,
  })
  async getHrLogsStats(
    @Request() req: AuthenticatedRequest,
  ): Promise<HrLogsStatsResponseDto> {
  ...
  async exportHrLogs(@Res() res: Response, @Query() query: ExportHrLogsDto) {
