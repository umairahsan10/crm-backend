...
export class SalaryController {
  ...
  @Get('deductions')
  @ApiOperation({
    summary: 'Calculate salary deductions for employees based on attendance',
  })
  @ApiQuery({
    name: 'employeeId',
    required: false,
    description: 'Optional employee ID to calculate for',
    type: Number,
  })
  @ApiQuery({
    name: 'month',
  ...
  @ApiResponse({
    status: 200,
    description: 'Calculated salary deductions',
