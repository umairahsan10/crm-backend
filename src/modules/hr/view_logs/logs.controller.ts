...
import { LateLogsStatsDto, LateLogsStatsResponseDto } from '../attendance/dto/late-logs-stats.dto';
import { ExportHalfDayLogsDto } from '../attendance/dto/export-half-day-logs.dto';
import { HalfDayLogsStatsDto, HalfDayLogsStatsResponseDto } from '../attendance/dto/half-day-logs-stats.dto';
import { ExportLeaveLogsDto } from '../attendance/dto/export-leave-logs.dto';
import { LeaveLogsStatsDto, LeaveLogsStatsResponseDto } from '../attendance/dto/leave-logs-stats.dto';
...
import { ProcessLeaveActionDto } from '../attendance/dto/process-leave-action.dto';
...
export class LogsController {
  ...
  async processLateAction(
    ...
    return this.lateLogsService.processLateAction(
      lateLogId,
      actionData.action,
  ...
  async processHalfDayAction(
    ...
    return this.halfDayLogsService.processHalfDayAction(
      halfDayLogId,
      actionData.action,
      actionData.reviewer_id,
  ...
  async processLeaveAction(
    ...
    return this.leaveLogsService.processLeaveAction(
      leaveLogId,
      actionData.action,
      actionData.reviewer_id,
