...
export class LateLogsListResponseDto {
  ...
  @ApiProperty({
    description: 'Full name of the employee related to the late log',
  })
  ...
  @ApiProperty({
    type: Boolean,
    nullable: true,
    description: 'Indicates if the lateness was justified',
  })
  ...
  @ApiProperty({
    enum: ['paid', 'unpaid'],
    nullable: true,
    description: 'Specifies whether the late entry is paid or unpaid',
  })
  late_type: 'paid' | 'unpaid' | null;

  @ApiProperty({
    enum: ['Created', 'Pending', 'Completed'],
    description: 'Current processing status of the late log',
  })
  ...
  @ApiProperty({
    type: Number,
    nullable: true,
    description: 'Reviewer ID who reviewed the late entry, if applicable',
  })
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Name of the reviewer who reviewed the late entry, if applicable',
  })
  reviewer_name: string | null;

  @ApiProperty({
    description: 'Timestamp when the late log was created (ISO 8601)',
  })
  created_at: string;

  @ApiProperty({
    description: 'Timestamp when the late log was last updated (ISO 8601)',
  })
  updated_at: string;
}
