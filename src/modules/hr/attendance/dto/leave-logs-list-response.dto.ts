...
export class LeaveLogsListResponseDto {
  ...
  @ApiProperty({ description: 'Full name of the employee who applied for the leave' })
  ...
  @ApiProperty({ type: Number, nullable: true, description: 'ID of the reviewer who processed the leave' })
  reviewed_by: number | null;

  @ApiProperty({ type: String, nullable: true, description: 'Name of the reviewer who processed the leave' })
