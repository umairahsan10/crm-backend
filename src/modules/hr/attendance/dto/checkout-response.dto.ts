...
export class CheckoutResponseDto {
  ...
  @ApiProperty({
    type: String,
    nullable: true,
    description: 'Timestamp of employee check-in (ISO 8601)',
  })
  checkin: string | null;
  ...
  @ApiProperty({
    type: String,
    nullable: true,
    description: 'Timestamp of employee check-out (ISO 8601)',
  })
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Local timestamp of employee check-out after timezone conversion (ISO 8601)',
  })
  ...
  @ApiProperty({
    enum: ['onsite', 'remote'],
    nullable: true,
    description: 'Mode of work for the day',
  })
  ...
  @ApiProperty({
    ...
    nullable: true,
    description: 'Final attendance status after checkout',
  })
  status: 'present' | 'late' | 'half_day' | 'absent' | null;

  @ApiProperty({
    description:
      'Total number of hours worked, calculated from check-in and check-out times',
  })
