...
export class UpdateCompanyDto {
  ...
  @ApiPropertyOptional({
    description: 'Absent deduction in salary',
    example: 500,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Half-day deduction in salary',
    example: 250,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Half-day time threshold in hours',
    example: 4,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Absent time threshold in hours',
    example: 8,
  })
  @IsOptional()
  @IsNumber()
