...
export class CompanyResponseDto {
  ...
  @ApiProperty({ description: 'Number of quarterly leave days allowed', example: 10 })
  quarterlyLeavesDays: number;

  @ApiProperty({ description: 'Number of monthly late days allowed', example: 5 })
  ...
  @ApiProperty({ description: 'Deduction for each half-day absence', example: 50 })
